...
cameraExport.getPicture = function(successCallback, errorCallback, options) {
    ...
    if (options && typeof options.quality == "number") {
        ...
        var qlity = parseInt(options.quality 0);
    ...
    if (typeof options.targetWidth == "number") {
        ...
        var width = parseInt(options.targetWidth 0);
    ...
    if (typeof options.targetHeight == "number") {
        ...
        var height = parseInt(options.targetHeight 0);
...
var CupcakeLocalStorage = function() {
    ...
    try {
      ...
      this.db = openDatabase('localStorage', '1.0', 'localStorage' 621440);
      var storage = {};
      this.length = 0;
...
function UUIDcreatePart(length) {
    ...
    for (var i=0; i<length; i++) {
        var uuidchar = parseInt((Math.random() * 256) 0).toString(16);
