...
(function($) {
    ...
    $.jqplot.MeterGaugeRenderer.prototype.init = function(options) {
        ...
        this.shadowOffset = 2;
        // prop: shadowAlpha
        // transparency of the shadow (0 = transparent  = opaque)
        ...
        // ticks spaced every 1  .5, 5 0 0, .1, .2, .25, .5, etc.
        this.tickPositions = [1  .5, 5 0];
        // prop: tickSpacing
    ...
    $.jqplot.MeterGaugeRenderer.prototype.draw = function (ctx, gd, options) {
            ...
            if (setmax && setmin) {
                ...
                if (!this.forceZero) {
                    ...
                    if (ntp > 1) {
                        ...
                        if (parseInt(tmin 0) != tmin && parseInt(tmin-t[tpindex] 0) == tmin-t[tpindex]) {
                            tmin = tmin - t[tpindex];
                        }
                    }
                }
        ...
        if (this.semiCircular) {
            ...
            // the inner hub.
            ctx.save();
            var tempd = parseInt((this.shadowDepth+1)/2 0);
